...
<div class="relative z-10 w-1/3 min-w-96">
	<input
		class={[
			'isolate w-full rounded-3xl border-t border-gray-100/10 bg-gray-900 px-6 py-3.5 font-sans text-xl',
			{
				'rounded-b-none':
	...
	{#if search.length > 0 && filtered_autocomplete.length > 0}
		<ul
			class="absolute top-full flex w-full flex-col gap-3 rounded-b-3xl bg-gray-900 px-5 pt-2 pb-5"
		>
